...
class WP_Connection implements ConnectionInterface {
	 ...
	 *
	 * @param \wpdb                                 $wpdb
	 * @param \Database\Query\Grammars\Grammar|null $queryGrammar
	 */
	public function __construct( wpdb $wpdb, Grammar $queryGrammar = null ) {
		$this->wpdb         = $wpdb;
		$this->queryGrammar = $queryGrammar ?: new WP_Grammar();
	 ...
	 * @return mixed
	 *
	 * @throws \Awethemes\WP_Object\Database\QueryException
	 */
